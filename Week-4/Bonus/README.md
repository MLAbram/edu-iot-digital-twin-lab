...
Note: sqlalchemy is a helper library that Pandas uses to communicate efficiently with PostgreSQL.

2. Run the Visualizer
Navigate to your root folder and run:

```bash
python Bonus/visualize_twin.py
```

3. The Results
Your default web browser should automatically open a new tab displaying your Temperature Trend.
